...
$t02_penerimaan_detail = NULL;

//
// Table class for t02_penerimaan_detail
//
class ct02_penerimaan_detail extends cTable {
	var $id;
	var $Urutan;
	var $Nomor;
	var $Kode;
	...
	function __construct() {
		...
		$this->TableVar = 't02_penerimaan_detail';
		$this->TableName = 't02_penerimaan_detail';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t02_penerimaan_detail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Urutan
		$this->Urutan = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Urutan', 'Urutan', '`Urutan`', '`Urutan`', 16, -1, FALSE, '`Urutan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nomor
		$this->Nomor = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Nomor', 'Nomor', '`Nomor`', '`Nomor`', 200, -1, FALSE, '`Nomor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nomor->Sortable = TRUE; // Allow sort
		$this->fields['Nomor'] = &$this->Nomor;

		// Kode
		$this->Kode = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Kode', 'Kode', '`Kode`', '`Kode`', 200, -1, FALSE, '`Kode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Kode->Sortable = TRUE; // Allow sort
		$this->fields['Kode'] = &$this->Kode;

		// Pos
		$this->Pos = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Pos', 'Pos', '`Pos`', '`Pos`', 200, -1, FALSE, '`Pos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pos->Sortable = TRUE; // Allow sort
		$this->fields['Pos'] = &$this->Pos;

		// Nominal
		$this->Nominal = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Nominal', 'Nominal', '`Nominal`', '`Nominal`', 4, -1, FALSE, '`Nominal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Banyaknya
		$this->Banyaknya = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Banyaknya', 'Banyaknya', '`Banyaknya`', '`Banyaknya`', 2, -1, FALSE, '`Banyaknya`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Satuan
		$this->Satuan = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Satuan', 'Satuan', '`Satuan`', '`Satuan`', 16, -1, FALSE, '`Satuan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jumlah
		$this->Jumlah = new cField('t02_penerimaan_detail', 't02_penerimaan_detail', 'x_Jumlah', 'Jumlah', '`Jumlah`', '`Jumlah`', 4, -1, FALSE, '`Jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	// Master filter
	function SqlMasterFilter_t01_penerimaan_head() {
		return "`Kode`='@Kode@'";
	}

	// Detail filter
	function SqlDetailFilter_t01_penerimaan_head() {
		return "`Kode`='@Kode@'";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t02_penerimaan_detail`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t02_penerimaan_detaillist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t02_penerimaan_detailedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t02_penerimaan_detailadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t02_penerimaan_detailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t02_penerimaan_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t02_penerimaan_detailadd.php?" . $this->UrlParm($parm);
		else
			$url = "t02_penerimaan_detailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t02_penerimaan_detailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t02_penerimaan_detailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t02_penerimaan_detaildelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "t01_penerimaan_head" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
