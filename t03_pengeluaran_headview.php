...
$t03_pengeluaran_head_view = NULL; // Initialize page object first

class ct03_pengeluaran_head_view extends ct03_pengeluaran_head {
	...
	// Page object name
	var $PageObjName = 't03_pengeluaran_head_view';
		...
		if ($url <> "") {
			...
			if ($this->IsModal) { // Show as modal
				...
				if ($pageName != $this->GetListUrl()) { // Not List page
					...
					if ($pageName == "t03_pengeluaran_headview.php")
						$row["view"] = "1";
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("t03_pengeluaran_headlist.php"); // Return to list page
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t03_pengeluaran_headlist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "t03_pengeluaran_headlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("t03_pengeluaran_headlist.php"), "", $this->TableVar, TRUE);
		$PageId = "view";
...
// Create page object
if (!isset($t03_pengeluaran_head_view)) $t03_pengeluaran_head_view = new ct03_pengeluaran_head_view();

// Page init
$t03_pengeluaran_head_view->Page_Init();

// Page main
$t03_pengeluaran_head_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_pengeluaran_head_view->Page_Render();
?>
...
var CurrentForm = ft03_pengeluaran_headview = new ew_Form("ft03_pengeluaran_headview", "view");

// Form_CustomValidate event
ft03_pengeluaran_headview.Form_CustomValidate = 
...
ft03_pengeluaran_headview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $t03_pengeluaran_head_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t03_pengeluaran_head_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $t03_pengeluaran_head_view->ShowPageHeader(); ?>
<?php
$t03_pengeluaran_head_view->ShowMessage();
?>
<form name="ft03_pengeluaran_headview" id="ft03_pengeluaran_headview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_pengeluaran_head_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_pengeluaran_head_view->Token ?>">
<?php } ?>
...
<?php if ($t03_pengeluaran_head->Kode->Visible) { // Kode ?>
	<tr id="r_Kode">
		<td class="col-sm-2"><span id="elh_t03_pengeluaran_head_Kode"><?php echo $t03_pengeluaran_head->Kode->FldCaption() ?></span></td>
...
<?php echo $t03_pengeluaran_head->Kode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_pengeluaran_head->Nama->Visible) { // Nama ?>
	<tr id="r_Nama">
		<td class="col-sm-2"><span id="elh_t03_pengeluaran_head_Nama"><?php echo $t03_pengeluaran_head->Nama->FldCaption() ?></span></td>
...
<?php if (!$t03_pengeluaran_head_view->IsModal) { ?>
<?php if (!isset($t03_pengeluaran_head_view->Pager)) $t03_pengeluaran_head_view->Pager = new cPrevNextPager($t03_pengeluaran_head_view->StartRec, $t03_pengeluaran_head_view->DisplayRecs, $t03_pengeluaran_head_view->TotalRecs, $t03_pengeluaran_head_view->AutoHidePager) ?>
<?php if ($t03_pengeluaran_head_view->Pager->RecordCount > 0 && $t03_pengeluaran_head_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t03_pengeluaran_head_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t03_pengeluaran_head_view->PageUrl() ?>start=<?php echo $t03_pengeluaran_head_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t03_pengeluaran_head_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t03_pengeluaran_head_view->PageUrl() ?>start=<?php echo $t03_pengeluaran_head_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t03_pengeluaran_head_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t03_pengeluaran_head_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t03_pengeluaran_head_view->PageUrl() ?>start=<?php echo $t03_pengeluaran_head_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t03_pengeluaran_head_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t03_pengeluaran_head_view->PageUrl() ?>start=<?php echo $t03_pengeluaran_head_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t03_pengeluaran_head_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<script type="text/javascript">
ft03_pengeluaran_headview.Init();
</script>
<?php
$t03_pengeluaran_head_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t03_pengeluaran_head_view->Page_Terminate();
?>
