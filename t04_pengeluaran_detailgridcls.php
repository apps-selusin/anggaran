...
$t04_pengeluaran_detail_grid = NULL; // Initialize page object first

class ct04_pengeluaran_detail_grid extends ct04_pengeluaran_detail {
	...
	// Page object name
	var $PageObjName = 't04_pengeluaran_detail_grid';

	// Grid form hidden field names
	var $FormName = 'ft04_pengeluaran_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t04_pengeluaran_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "t03_pengeluaran_head") {
			...
			if ($GLOBALS["t03_pengeluaran_head"]->EventCancelled) $this->EventCancelled = TRUE;
		}
