...
//
// Table class for t98_log
//
class ct98_log extends cTable {
	var $id;
	var $No;
	var $Keterangan;
	var $Keterangan2;
	...
	function __construct() {
		...
		$this->TableVar = 't98_log';
		$this->TableName = 't98_log';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t98_log`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t98_log', 't98_log', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// No
		$this->No = new cField('t98_log', 't98_log', 'x_No', 'No', '`No`', '`No`', 3, -1, FALSE, '`No`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->No->Sortable = TRUE; // Allow sort
		$this->No->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['No'] = &$this->No;

		// Keterangan
		$this->Keterangan = new cField('t98_log', 't98_log', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 201, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// Keterangan2
		$this->Keterangan2 = new cField('t98_log', 't98_log', 'x_Keterangan2', 'Keterangan2', '`Keterangan2`', '`Keterangan2`', 201, -1, FALSE, '`Keterangan2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t98_log`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t98_logedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t98_logadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t98_logview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t98_logview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t98_logadd.php?" . $this->UrlParm($parm);
		else
			$url = "t98_logadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t98_logedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t98_logadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t98_logdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->TanggalJam->setDbValue($rs->fields('TanggalJam'));
	}
	...
	function RenderEditRow() {
		...
		$this->Keterangan2->EditValue = $this->Keterangan2->CurrentValue;
