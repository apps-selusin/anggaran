...
define("EWR_PROJECT_ID", "{CE2BFCDC-32CE-41CA-ABF9-868662EE06FE}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "prj_anggaran", TRUE); // Project Name
...
define("EWR_FONT_SIZE", 11, TRUE);
$EWR_BODY_CLASS = "hold-transition skin-green";
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3434, "user" => "root", "pass" => "kebersamaan", "db" => "db_anggaran", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'Ya4F7SCxcIc22hIR', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/prj_anggaran.css", TRUE); // Project stylesheet file name
...
define("EWR_TABLE_PREFIX", "{CE2BFCDC-32CE-41CA-ABF9-868662EE06FE}", TRUE);
